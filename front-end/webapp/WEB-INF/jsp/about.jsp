...
<section class="py-5 text-dark" style="color: var(--text-base) !important;">
    <div class="container">
        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-5 text-center" data-aos="fade-right">
                <div class="owner-photo-frame glass-card shadow-lg p-2 mx-auto" style="max-width: 380px;">
                    ...
                    <div class="bg-secondary-custom text-white p-3 rounded-bottom-4 mt-2" style="background-color: var(--secondary-color) !important;">
            ...
            <div class="col-lg-7" data-aos="fade-left">
                <div class="ps-lg-4">
                    ...
                    <div class="quote-block border-start border-primary border-4 ps-3 my-4 glass-card py-3">
                        <p class="mb-0 text-muted font-italic" style="font-style: italic; font-size: 1.1rem;">
        ...
        <div class="row g-4">
            <div class="col-md-4" data-aos="zoom-in" data-aos-delay="100">
                <div class="glass-card p-4 text-center h-100">
                    ...
                    <a href="https://maps.google.com/?q=Hingangaon+Bk+Paranda" target="_blank" class="btn btn-sm btn-outline-custom mt-auto"><i class="fa-solid fa-map-location-dot me-1"></i> Locate on Google Maps</a>
                </div>
            </div>
            ...
            <div class="col-md-4" data-aos="zoom-in" data-aos-delay="200">
                <div class="glass-card p-4 text-center h-100">
                    ...
                    <div class="d-flex gap-2 justify-content-center mt-auto">
                        <a href="tel:+919588430156" class="btn btn-sm btn-primary-custom"><i class="fa-solid fa-phone me-1"></i> Call Now</a>
            ...
            <div class="col-md-4" data-aos="zoom-in" data-aos-delay="300">
                <div class="glass-card p-4 text-center h-100">
                    ...
                    <div class="d-flex gap-2 justify-content-center mt-auto">
                        <a href="mailto:dipaksarpane@gmail.com" class="btn btn-sm btn-outline-custom"><i class="fa-solid fa-envelope me-1"></i> Email Us</a>
