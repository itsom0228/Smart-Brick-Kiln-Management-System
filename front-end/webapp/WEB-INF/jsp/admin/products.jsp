...
<head>
    ...
    <title>Product Catalog - Smart Brick Kiln</title>
...
<div class="admin-wrapper">
    ...
    <div class="admin-main">
        <div class="d-flex justify-content-between align-items-center mb-4 border-bottom pb-3">
            <h2 class="text-secondary-custom font-weight-bold mb-0">Product Catalog Management</h2>
            <a href="${pageContext.request.contextPath}/admin/products/add" class="btn btn-primary-custom"><i class="fa-solid fa-plus-circle me-1"></i>Add New Product</a>
        </div>
                ...
                <table class="table align-middle table-hover">
                    ...
                    <tbody>
                        <c:forEach var="p" items="${products}">
                            <tr>
                                <td>
                                    <img src="${p.imageUrl}" alt="${p.name}" width="50" height="40" class="rounded object-fit-cover"
                                         onerror="this.onerror=null; this.src='https://images.unsplash.com/photo-1590069261209-f8e9b8642343?auto=format&fit=crop&w=100&q=80';">
                                </td>
                                ...
                                <td>
                                    <div class="d-flex gap-2">
                                        <a href="${pageContext.request.contextPath}/admin/products/edit/${p.id}" class="btn btn-sm btn-light text-primary-custom" title="Edit Product"><i class="fa-solid fa-edit"></i></a>
                                        <form action="${pageContext.request.contextPath}/admin/products/delete/${p.id}" method="post" onsubmit="return confirm('Are you sure you want to delete this product?');">
                                            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                                            <button type="submit" class="btn btn-sm btn-light text-danger" title="Delete Product"><i class="fa-solid fa-trash"></i></button>
                                        </form>
                                    </div>
                                </td>
                            </tr>
